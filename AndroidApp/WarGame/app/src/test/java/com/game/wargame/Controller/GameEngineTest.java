...
public class GameEngineTest {
    ...
    public void testIfLocalPlayersIsCorrectlyAddedAtTheBeginningOfTheGame() {
        ...
        mGameEngine.onStart(mMockGameView, mMockGameSocket, mMockMap, mMockLocalPlayerSocket, mMockGPSSensorLocationUpdater, mMockGlobalTimer, mMockSettings);
    ...
    public void testIfLocationRetrieverIsStoppedWhenGameEngineIsStopped() {
        ...
        verify(mMockGPSSensorLocationUpdater).stop();
    }
